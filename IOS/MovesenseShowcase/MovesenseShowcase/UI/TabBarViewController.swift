...
class TabBarViewController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        if #available(iOS 15, *) {
            ...
            dashboardTab.tabBarItem.scrollEdgeAppearance = appearance
        }
        ...
        if #available(iOS 15, *) {
            ...
            appearance.configureWithOpaqueBackground()
            appearance.backgroundColor = .white
            sensorsTab.tabBarItem.scrollEdgeAppearance = appearance
        }
        ...
        if #available(iOS 15, *) {
            ...
            appearance.configureWithOpaqueBackground()
            appearance.backgroundColor = .white
            recordTab.tabBarItem.scrollEdgeAppearance = appearance
        }
        ...
        if #available(iOS 15, *) {
            ...
            appearance.configureWithOpaqueBackground()
            appearance.backgroundColor = .white
            recordingsTab.tabBarItem.scrollEdgeAppearance = appearance
        }
        ...
        if #available(iOS 15, *) {
            ...
            appearance.configureWithOpaqueBackground()
            appearance.backgroundColor = .white
            moreTab.tabBarItem.scrollEdgeAppearance = appearance
        }
